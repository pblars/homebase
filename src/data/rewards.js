...
const REWARDS = [
  { isoWeek: 1, questName: 'The Meadow Quest',   theme: ['Kindness', 'Teamwork', 'Adventure'],  reward: 'Movie night — kids pick the film',  rewardIcon: 'movie' },
  { isoWeek: 2, questName: 'The Forest Quest',   theme: ['Courage', 'Curiosity', 'Care'],       reward: 'Ice cream outing',                  rewardIcon: 'ice-cream' },
  { isoWeek: 3, questName: 'The River Quest',    theme: ['Patience', 'Perseverance', 'Joy'],    reward: 'Stay up 30 min late Friday',        rewardIcon: 'moon-stars' },
  { isoWeek: 4, questName: 'The Mountain Quest', theme: ['Strength', 'Grit', 'Together'],       reward: 'Backyard bonfire',                  rewardIcon: 'flame' },
];
